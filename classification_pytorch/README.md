PyTorch implementation of the ordinal classification model for street-view images. The folder also includes two shell scripts as examples on how to call the python file. 
